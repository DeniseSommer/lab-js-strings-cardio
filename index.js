...
// Your code here...
const findChar = string1.indexOf("j");
...
// Your code here...
const word = `${string2[2]}${string2[11]}${string2[11]}${string2[10]}`;
...
// Your code here...
const favouriteFruit = fruit.slice(
  fruit.indexOf("orange"),
  fruit.indexOf("orange") + "orange".length
);
...
// Your code here ...
const word1 = funnyHeadline1.includes("oxygen");
console.log(word1);
